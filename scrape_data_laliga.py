...
for page in range(1, 21, 1):
    page_url = 'https://www.transfermarkt.com/laliga/marktwertaenderungen/wettbewerb/ES1/pos//detailpos/0/verein_id/0/land_id/0/plus/1' + '/page/' + str(page)
    driver.get(page_url)
...
myFile = open('footballer_info_laliga.csv', 'w', encoding="utf-16", newline='')
