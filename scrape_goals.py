...
for page in range(1, 10, 1):
    page_url = 'https://www.transfermarkt.com/premier-league/torschuetzenliste/wettbewerb/GB1/ajax/yw1/saison_id/2022' + '/page/' + str(page)
    driver.get(page_url)
...
myFile = open('footballer_goals.csv', 'w', encoding="utf-16", newline='')
