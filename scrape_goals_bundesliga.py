...
for page in range(1, 11, 1):
    page_url = 'https://www.transfermarkt.com/bundesliga/torschuetzenliste/wettbewerb/L1/ajax/yw1/saison_id/2022' + '/page/' + str(page)
    driver.get(page_url)
...
myFile = open('footballer_goals_bundesliga.csv', 'w', encoding="utf-16", newline='')
